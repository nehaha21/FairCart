      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        {biasScore && (
          <div className="modal-bias" style={{ borderColor: cfg.color }}>
            <div className="modal-bias-label" style={{ color: cfg.color }}>{cfg.label}</div>
            <div className="modal-stats">
              ...
              <div className="stat">
                ...
                <span className="stat-label">Equivalent Price</span>
              </div>
              <div className="stat">
                <span className="stat-val" style={{ color: cfg.color }}>+{biasScore.percentDiff}%</span>
                <span className="stat-label">Markup</span>
              </div>
              <div className="stat">
                <span className="stat-val" style={{ color: cfg.color }}>₹{biasScore.lifetimeCost}</span>
          ...
          <div className="category-avg">
            ...
            <div className="avg-row">
              ...
              <div className="avg-bar-bg">
                <div className="avg-bar-fill female" style={{ width: `${(categoryAvgFemale / (categoryAvgFemale + categoryAvgMale)) * 100}%` }} />
              </div>
            </div>
            <div className="avg-row">
              <div className="avg-bar-label">Men's avg: ₹{categoryAvgMale.toFixed(0)}</div>
              <div className="avg-bar-bg">
                <div className="avg-bar-fill male" style={{ width: `${(categoryAvgMale / (categoryAvgFemale + categoryAvgMale)) * 100}%` }} />
              </div>
            </div>
          </div>
        )}
              ...
              {alternatives.map((alt) => (
                <div key={alt._id} className="alt-card">
                  <img
                    ...
                    alt={alt.name}
                    className="alt-img"
                    onError={(e) => { e.target.src = "https://via.placeholder.com/60?text=NA"; }}
                  />
                  <div>
